...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            $res=mysqli_query($connection, "SELECT * FROM movie_information order by id");
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-5">
                                    <div class="product-slider-single normal-slider">
                                        <img src="movie_photo/<?php echo $row['image']; ?>" alt="photo of movie" width="200" height="300">
                                    </div>
                                ...
                                <div class="col-md-7">
                                    <div class="product-content">
                                        ...
                                        <div class="action">
                                          <a class="btn" href="watch_movies.php?id=<?php echo $row['id'];  ?>"><i class="fa fa-movie"></i>Watch Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
